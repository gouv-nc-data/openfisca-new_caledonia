...
install: deps
	...
	@# `make install` installs the editable version of openfisca-new_caledonia.
...
test: clean check-syntax-errors check-style
	openfisca test --country-package openfisca_new_caledonia openfisca_new_caledonia/tests

serve-local: build
	openfisca serve --country-package openfisca_new_caledonia
